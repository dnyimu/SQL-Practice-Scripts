...
-- find all the the purple cars sold and all the automatic cars( not complete)
 select uc.color, bmw.color, uc.transmission_type, bmw.transmission, bmw.model, uc. make
    from usedcars as uc
   FULL join bmw_car_sales_classification as bmw on uc.color= bmw.color
   
   
   
    where uc.color='purple'and bmw.color= 'purple'
...
select uc.color, bmw.color, uc.transmission_type, bmw.transmission     from usedcars as uc     full outer join  bmw_car_sales_classification as bmw on uc.color= bmw.color     where uc.color='purple'  and bmw.color= 'purple'         and uc.transmission_type= 'automatic' and bmw.transmission= 'automatic'
